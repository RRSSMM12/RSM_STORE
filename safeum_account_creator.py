...
#open source by RANI 
#WLCM TO SAFE UP AUTO CREATE
#VERSION :- 1
import requests, random, requests, json, pyfiglet,sys,time, os, uuid, webbrowser, fake_useragent,sys
...
def work():
 ...
 try:
  ...
  if '"status":"Success"' in gzip:
   ...
   print(b)
   with open('SafeUM-Accounts.txt', 'a') as f: f.write(username + ":hhhh | \n")
